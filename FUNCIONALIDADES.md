...
O M. Imobiliario e uma plataforma SaaS multi-tenant para imobiliarias. Cada imobiliaria pode ter seu site publico, painel administrativo, catalogo de imoveis, captacao de leads, agenda, blog e configuracoes proprias. Tambem existe um painel master para gerenciar empresas e planos.
...
| Painel master | `/master`, `/master/empresas`, `/master/planos` | Administracao SaaS da plataforma |
| APIs | `/api/ai/descricao`, `/api/ai/chat`, `/api/ai/lead-score` | Integracoes de IA |
...
- Chamada para contato direto com a equipe comercial.
...
- Planos cadastrados no painel master.
- Exibicao publica dos planos ativos.
- Botao para contato direto com a equipe comercial.
- Assinaturas podem ser acompanhadas pelo status cadastrado no sistema.
  - data de criacao.
- Status previstos:
  - aprovado;
  - pendente;
