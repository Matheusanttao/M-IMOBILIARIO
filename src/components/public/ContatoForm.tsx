  ...
  return (
    <div className="grid gap-12 lg:grid-cols-5">
      ...
      <div className="lg:col-span-3">
        <div className="rounded-2xl border border-white/10 bg-card p-6 shadow-xl shadow-black/20 sm:p-8">
          ...
          <form
            ...
            className="mt-6 space-y-4 [&_input]:border-white/10 [&_input]:bg-white/[0.04] [&_input]:text-white [&_input]:placeholder:text-white/35 [&_label]:!text-white/70 [&_textarea]:border-white/10 [&_textarea]:bg-white/[0.04] [&_textarea]:text-white [&_textarea]:placeholder:text-white/35"
          >
            <Input
              label="Nome"
        ...
        <div className="rounded-2xl border border-white/10 bg-card p-6 shadow-xl shadow-black/20">
          ...
          <ul className="mt-4 space-y-4 text-sm text-white/60">
            ...
            <li className="flex items-start gap-3">
              ...
              <div>
                <span className="block font-medium text-white">Endereço</span>
